      ...
      <div className="certification-container">
        {certifications.map((cert) => (
          <div key={cert.id} className="certification">
            <div className="certfication-backdrop" data-content={cert.name}>
              {/* Optional: SVG icon here */}
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id={`gradient${cert.id}`} x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: "#57370d", stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: "#ffe998", stopOpacity: 1 }} />
                  </linearGradient>
                </defs>
                <path
            ...
            <h1><strong>{cert.title}</strong></h1>
            <h3><strong>Provider</strong>: {cert.provider}</h3>
            <h3><strong>Duration</strong>: {cert.duration}</h3>
            <h3><strong>Grade</strong>: {cert.grade}</h3>
            <h3><strong>Expected Completion</strong>: {cert.completion}</h3>
